...
<template>
  <div class="workspace-shell">
    ...
    <aside :class="['sidebar', { open: mobileOpen }]">
      ...
      <footer class="sidebar-footer"><router-link to="/"><el-icon><Download /></el-icon>客户端下载</router-link><small>版本 2.1.0</small></footer>
    </aside>
