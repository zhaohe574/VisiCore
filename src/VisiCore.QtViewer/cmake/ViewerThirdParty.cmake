...
set(VISICORE_QLEMENTINE_VERSION "1.4.2")
set(VISICORE_QLEMENTINE_ARCHIVE_SHA256 "ED5196E6E04614DB65F9A5F813EB35BF05076B7BCE07892DB33E85CF7B598616")
set(VISICORE_QT_ADS_VERSION "5.0.0")
set(VISICORE_QT_ADS_ARCHIVE_SHA256 "12AFA0F1EB32FB123568DC2435E8C12D0E87A49934D8BA4EF746F9DE2BFC799C")
set(VISICORE_LUCIDE_VERSION "1.23.0")
set(VISICORE_LUCIDE_ARCHIVE_SHA256 "5160BC6E37FDA62286B36610BFA314DC7F5D53218DFB87F1F5540F40414D8B9B")

set(VISICORE_QLEMENTINE_SOURCE_ARCHIVE "" CACHE FILEPATH
    "Qlementine 1.4.2 已审批源码归档；为空时从固定官方地址下载。")
set(VISICORE_QT_ADS_SOURCE_ARCHIVE "" CACHE FILEPATH
    "Qt ADS 5.0.0 已审批源码归档；为空时从固定官方地址下载。")
set(VISICORE_LUCIDE_SOURCE_ARCHIVE "" CACHE FILEPATH
    "Lucide 1.23.0 已审批源码归档；为空时从固定官方地址下载。")

function(visicore_resolve_archive output_variable local_archive official_url description)
    if(local_archive)
...
macro(visicore_populate dependency_name)
...
visicore_resolve_archive(
    qlementine_archive
    "${VISICORE_QLEMENTINE_SOURCE_ARCHIVE}"
    "https://github.com/oclero/qlementine/archive/refs/tags/v1.4.2.tar.gz"
    "Qlementine 1.4.2")
FetchContent_Declare(qlementine
    URL "${qlementine_archive}"
    URL_HASH "SHA256=${VISICORE_QLEMENTINE_ARCHIVE_SHA256}"
    DOWNLOAD_EXTRACT_TIMESTAMP TRUE)
visicore_populate(qlementine)
...
visicore_resolve_archive(
    qt_ads_archive
    "${VISICORE_QT_ADS_SOURCE_ARCHIVE}"
    "https://github.com/githubuser0xFFFF/Qt-Advanced-Docking-System/archive/refs/tags/5.0.0.tar.gz"
    "Qt ADS 5.0.0")
FetchContent_Declare(qt_ads
    URL "${qt_ads_archive}"
    URL_HASH "SHA256=${VISICORE_QT_ADS_ARCHIVE_SHA256}"
    DOWNLOAD_EXTRACT_TIMESTAMP TRUE)
visicore_populate(qt_ads)
set(ADS_VERSION "${VISICORE_QT_ADS_VERSION}")
...
visicore_resolve_archive(
    lucide_archive
    "${VISICORE_LUCIDE_SOURCE_ARCHIVE}"
    "https://github.com/lucide-icons/lucide/archive/refs/tags/1.23.0.tar.gz"
    "Lucide 1.23.0")
FetchContent_Declare(lucide
    URL "${lucide_archive}"
    URL_HASH "SHA256=${VISICORE_LUCIDE_ARCHIVE_SHA256}"
    DOWNLOAD_EXTRACT_TIMESTAMP TRUE)
visicore_populate(lucide)

set(VISICORE_LUCIDE_ICON_NAMES
    camera
    folder
    video
    play
...
set(VISICORE_LUCIDE_ICON_FILES "")
foreach(icon_name IN LISTS VISICORE_LUCIDE_ICON_NAMES)
    list(APPEND VISICORE_LUCIDE_ICON_FILES "${lucide_SOURCE_DIR}/icons/${icon_name}.svg")
endforeach()
...
list(APPEND VISICORE_LUCIDE_ICON_FILES
    "${lucide_unlock_icon}"
