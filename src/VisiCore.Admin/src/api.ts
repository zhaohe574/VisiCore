...
const tokenKey = 'visicore-admin-token'
const userKey = 'visicore-admin-user'
const passwordChangeRequiredKey = 'visicore-admin-password-change-required'
...
export type InitialSetupResponse = { state: string; recoveryKey?: string }

export const api = {
  setupStatus: () => anonymousRequest<SetupStatus>('/api/v1/setup/status'),
  initialize: (body: SetupRequest) => anonymousRequest<InitialSetupResponse>('/api/v1/setup/initialize', { method: 'POST', body: JSON.stringify(body) }),
  restoreSetup: (body: FormData) => anonymousRequest<InitialSetupResponse>('/api/v1/setup/restore', { method: 'POST', body }),
