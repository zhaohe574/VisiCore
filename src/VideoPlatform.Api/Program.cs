...
{
    builder.Host.UseWindowsService(options => options.ServiceName = "VideoPlatformCenterApi");
}
else
{
...
app.UseExceptionHandler(exceptionApp =>
{
    exceptionApp.Run(async context =>
    {
        ...
        {
            var logger = context.RequestServices.GetRequiredService<ILoggerFactory>().CreateLogger("VideoPlatform.Api.ExceptionHandler");
...
else
{
        ...
        CancellationToken cancellationToken) =>
    {
        ...
        {
            loggerFactory.CreateLogger("VideoPlatform.Api.Login").LogError(exception, "登录时无法访问平台数据库。");
        ...
        CancellationToken cancellationToken) =>
    {
        ...
        {
            loggerFactory.CreateLogger("VideoPlatform.Api.AccountPasswordChange").LogError(
