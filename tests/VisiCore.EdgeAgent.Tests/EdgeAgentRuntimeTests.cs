...
public sealed class EdgeAgentRuntimeTests
{
    ...
    public async Task RollbackUsesPreviousKnownGoodArtifact()
    {
        ...
        try
        {
            ...
            var first = new HostVerifiedReleaseArtifact(null, null, new string('a', 64), "visicore/visicore-edge@sha256:" + new string('a', 64), "0.1.0");
            var second = new HostVerifiedReleaseArtifact(null, null, new string('b', 64), "visicore/visicore-edge@sha256:" + new string('b', 64), "0.1.1");
